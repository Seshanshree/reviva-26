...
const events = [
  ...
  { id: 5, icon: "🧠", name: "Brain Blitz", category: "TECHNICAL GK", short: "A rapid-fire technical general knowledge battle covering all ECE domains from signals to semiconductors.", rules: ["Solo performance", "Multiple choice", "Final round is live buzzer battle"], solo: "₹200", team: "₹200 (Solo)" },
  { id: 6, icon: "🐞", name: "Bug Busters", category: "DEBUGGING CHALLENGE", short: "Hunt down and destroy bugs like broken C, Python, and MATLAB code under intense time pressure.", rules: ["Solo performance","Languages Like: C, Python, Embedded C","Partial marks for partial fixes"], solo: "₹200", team: "₹200 (Solo)" },
