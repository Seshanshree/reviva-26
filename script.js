...
// ============ EVENTS DATA ============
const events = [
  { id: 1, icon: "📄", name: "InnoPaper Summit", category: "PAPER PRESENTATION", short: "Present your research paper to a panel of expert judges and win recognition for your academic brilliance.", rules: ["Abstract submission required", "3-4 members per team", "PPT mandatory", "10 min presentation", "IEEE format preferred","Team: ₹600 (Team of 3)" ,"Offer: Team: ₹600 (Team of 4)"] },
  { id: 2, icon: "🏗️", name: "Future Builders Arena", category: "PROJECT EXPO", short: "Showcase your innovative project prototype and pitch it like a startup to our industry expert panel.", rules: ["3-4 members per team", "Working prototype must be brought", "5-minute pitch + demo", "Innovation & feasibility judged", "Hardcopy of report required","Team: ₹600 (Team of 3)", "Offer: Team: ₹600 (Team of 4)"]},
  ...
  { id: 3, icon: "💡", name: "TechSphere Talks", category: "TECHNICAL QUIZ", short: "A high-voltage technical quiz covering electronics, communications, circuits, and cutting-edge technology.", rules: ["Individual event","2 rounds: Prelims, Finals", "No electronic devices in quiz hall", "Rapid fire in final round", "Judge's decision is final", "Solo: ₹200"], solo: "₹200", team: "₹200 (Solo)" },
  { id: 4, icon: "🧩", name: "Mind Maze", category: "PUZZLE & LATERAL THINKING", short: "Navigate through complex technical puzzles, riddles, and lateral thinking challenges that test your engineering mind.", rules: ["Individual event", "2 levels of difficulty", "No internet access permitted", "Scoring based on accuracy & speed","Solo: ₹200"], solo: "₹200", team: "₹200 (Solo)" },
  { id: 5, icon: "🧠", name: "Brain Blitz", category: "TECHNICAL GK", short: "A rapid-fire technical general knowledge battle covering all ECE domains from signals to semiconductors.", rules: ["Individual event", "Multiple choice", "Final round is live buzzer battle","Solo: ₹200"], solo: "₹200", team: "₹200 (Solo)" },
  { id: 6, icon: "🐞", name: "Bug Busters", category: "DEBUGGING CHALLENGE", short: "Hunt down and destroy bugs like broken C, Python, and MATLAB code under intense time pressure.", rules: ["Individual event","Languages Like: C, Python, Embedded C","Partial marks for partial fixes","Solo: ₹200"], solo: "₹200", team: "₹200 (Solo)" },
  { id: 7, icon: "⚡", name: "Electrofix", category: "HARDWARE TROUBLESHOOTING", short: "Diagnose and repair malfunctioning electronic circuits using your hands, tools, and engineering instincts.", rules: ["Individual event", "Faulty circuit boards provided", "Tools available at venue", "Judged on accuracy & explanation","Solo: ₹200"], solo: "₹200", team: "₹200 (Solo)" },
];
