...
// ============ EVENTS DATA ============
const events = [
  { id: 1, icon: "📄", name: "InnoPaper Summit", category: "PAPER PRESENTATION", short: "Present your research paper to a panel of expert judges and win recognition for your academic brilliance.", rules: ["Abstract submission required", "3-4 members per team", "PPT mandatory", "10 min presentation", "IEEE format preferred", "Solo: ₹200","Team: ₹600 (Team of 3)" ,"Team: ₹600 (Team of 4)"] },
  { id: 2, icon: "🏗️", name: "Future Builders Arena", category: "PROJECT EXPO", short: "Showcase your innovative project prototype and pitch it like a startup to our industry expert panel.", rules: ["3-4 members per team", "Working prototype must be brought", "5-minute pitch + demo", "Innovation & feasibility judged", "Hardcopy of report required","Solo: ₹200","Team: ₹600 (Team of 3)", "Team: ₹600 (Team of 4)"]},
  ...
  { id: 3, icon: "💡", name: "TechSphere Talks", category: "TECHNICAL QUIZ", short: "A high-voltage technical quiz covering electronics, communications, circuits, and cutting-edge technology.", rules: ["Individual event","3 rounds: Prelims, Semi-finals, Finals", "No electronic devices in quiz hall", "Rapid fire in final round", "Judge's decision is final", "Solo: ₹200"], solo: "₹200", team: "₹200 (Solo)" },
